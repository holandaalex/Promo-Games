    ...
    cart.forEach(item => {
      ...
      cartItemElement.innerHTML = `
        <div class="flex items-center justify-between">
          ...
          <button class="remove-from-cart-btn hover:cursor-pointer hover:font-bold" data-name="${item.name}">
            Remover
          </button>
    ...
    if(addressInput.value === ""){
      ...
      return;
        ...
        const cartItems = cart.map((item) => {
          ...
          const phone = "61900000000"
          // REALMENTE FUNCIONA, É SÓ COLOCAR UM NÚMERO DE VERDADE
